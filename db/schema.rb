...
ActiveRecord::Schema.define(version: 2020_02_17_112335) do
  ...
  create_table "users_blogs", id: false, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4", force: :cascade do |t|
    t.bigint "user_id"
    t.bigint "blog_id"
    t.index ["blog_id"], name: "index_users_blogs_on_blog_id"
    t.index ["user_id"], name: "index_users_blogs_on_user_id"
  end
